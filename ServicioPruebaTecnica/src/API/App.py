...
@app.route('/pruebatecnica/healthcheck', methods=['GET'])
def HealthCheck():
    resp = Response()
    resp.status_code = 200
    return jsonify({'status': 'alive!'})

@app.route('/pruebatecnica/preguntas', methods=['GET'])
...
@app.route('/pruebatecnica/preguntas', methods=['POST'])
def crear_preguntas():
...
@app.route('/pruebatecnica/preguntas', methods=['PUT'])
